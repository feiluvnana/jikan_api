...
import 'package:jikan_api/src/types/relation.dart';
import 'package:jikan_api/src/types/theme.dart';
...
part 'anime_full.freezed.dart';
part 'anime_full.g.dart';

@freezed
class AnimeFull with _$AnimeFull {
  @JsonSerializable(fieldRename: FieldRename.snake)
  const factory AnimeFull({
    /// MyAnimeList ID
    required int malId,
    ...
    required List<Url> external,
    required List<Url> streaming,
  }) = _AnimeFull;

  factory AnimeFull.fromJson(Map<String, dynamic> json) =>
      _$AnimeFullFromJson(json);
}
